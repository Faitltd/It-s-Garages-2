import { pgTable, serial, text, varchar, integer, jsonb, timestamp, boolean, numeric, index, uniqueIndex } from "drizzle-orm/pg-core";
...
export const technicians = pgTable("technicians", {
  ...
  phone: varchar("phone", { length: 40 }),
  email: varchar("email", { length: 160 }),
  serviceAreas: jsonb("service_areas"),    // ZIP codes array
  skills: jsonb("skills"),                 // ["install-door", "opener", "repair"]
